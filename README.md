...
| [`workflows/STRUCTURE_WORKFLOW.md`](workflows/STRUCTURE_WORKFLOW.md) | Длинный чеклист для LLM: установка или пересборка **всего** workspace |
| [`.agents/skills/structure-workspace/`](.agents/skills/structure-workspace/SKILL.md) | Skill: когда ставить весь workspace — открыть и исполнить `STRUCTURE_WORKFLOW.md` |
| [`.agents/skills/structure-template/`](.agents/skills/structure-template/SKILL.md) | Skill: одна папка с нуля или только недостающие бланки |
| [`.agents/skills/structure-revise/`](.agents/skills/structure-revise/SKILL.md) | Skill: ревизия одной папки, смена типа, разнесение уже лежащего текста |
