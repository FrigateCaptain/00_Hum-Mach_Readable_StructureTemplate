...
- сделать это руками ии-шки (есть воркфлоу для ии-деплоя)
...
Шаблон описывает шесть структурных типов папок, каждый из которых решает свою задачу:
...
> **Про «базу знаний».** Классическая база знаний часто сидит на границе storage и groundwork: готовые ответы и how-to тяготеют к наработкам (groundwork / доменный канон), а «полка» файлов и подборок без роли каталога how-to — к storage. Поэтому в примере для storage выше нет одной только «базы знаний»; вместо неё — три более однозначных случая.
...
*Дата актуализации: 3 августа 2026, 13:11*
